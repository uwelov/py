...
button_signup = Button(root, text='SIGN UP', bg='#9955cc', command=registration)
button_signup.place(relx=0.2, rely=0.1, relwidth=0.3)

button_signin = Button(root, text='SIGN IN', bg='#9955cc', command=login_form)

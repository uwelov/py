...
from data.components import portal
from data.states import player_menu
from data import tilerender
...
class LevelState(tools._State):
        ...
        for object in self.renderer.tmx_data.objects:
            ...
            if properties['name'] == 'sprite':
                ...
                if 'battle' in properties:
                    battle = properties['properties']['battle']
                else:
                    battle = None

                if 'state' in properties:
                    sprite_state = properties['properties']['state']
                else:
                    sprite_state = None
                x = properties['x'] * 2
                y = ((properties['y']) * 2) - 32
    ...
    def make_level_portals(self):
        ...
        for object in list(self.renderer.tmx_data.tilesets):
            properties = object.__dict__
